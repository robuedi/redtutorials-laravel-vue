...
<header id="header">
    <div id="logo-group">
        ...
        <span id="logo"> <a href="/{{config('app.admin_route')}}"><img src="{{url('/assets/_admin/')}}/img/logo.png" height="50" alt="{{config('app.name')}}"></a> </span>
        ...
        <ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-5">
            <li class="">
                <a href="#" class="dropdown-toggle no-margin userdropdown" data-toggle="dropdown">
                    <img src="{{url('/assets/_admin/')}}/img/avatars/male.png" alt="{{$user_name}} " class="online" />
                </a>
